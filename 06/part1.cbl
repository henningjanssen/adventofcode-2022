      * Compile: `cobc -x part1.cbl`
       ...
       100-MAIN.
           ...
           VARYING WS-CTX FROM 1 BY 1 UNTIL WS-CTX = 4.
           ...
           MOVE WS-LASTTHREE(2:2) TO WS-LASTTHREE(1:2).
           MOVE WS-CURRENTCHAR TO WS-LASTTHREE(3:1).
           SUBTRACT 1 FROM WS-NEEDED-OFFSET.
       100-EXIT.
           EXIT.

       150-CMP-CHARS.
           IF WS-LASTTHREE(WS-CTX:1) = WS-CURRENTCHAR
